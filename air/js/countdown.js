...
var classNamesCountdown = ['', '', 'minutes', 'secondes'];
...
//var endCountdown = new Date().getTime() + 10000;
...
function doCountCountdown(){
	//console.log(theDiffCountdown);
	if (theDiffCountdown >= 1000)
	{	
